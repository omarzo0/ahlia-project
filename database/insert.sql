...
VALUES 
	...
	('Computer Engineering', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Computer Science', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Administrative Sciences', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Arts', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Business', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('dentistry', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Economics', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('media', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('medicine', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Nursing', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('pharma', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('physical therapy', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data)),
	('Veterinary_Medicine', (SELECT BulkColumn FROM OPENROWSET(BULK 'your_img_path', SINGLE_BLOB) AS image_data));
