...
VALUES 
	('Engineering', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\Engineering.jpeg', SINGLE_BLOB) AS image_data)),
	('Computer Engineering', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\computer_engineering.jpeg', SINGLE_BLOB) AS image_data)),
	('Computer Science', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\computer_science.jpg', SINGLE_BLOB) AS image_data)),
	('Administrative Sciences', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\administrative_science.webp', SINGLE_BLOB) AS image_data)),
	('Arts', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\arts_design.jpg', SINGLE_BLOB) AS image_data)),
	('Business', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\business.jpg', SINGLE_BLOB) AS image_data)),
	('dentistry', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\dentistry.jpg', SINGLE_BLOB) AS image_data)),
	('Economics', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\Economics and Management.jpeg', SINGLE_BLOB) AS image_data)),
	('media', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\media.jpg', SINGLE_BLOB) AS image_data)),
	('medicine', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\medicine.jpg', SINGLE_BLOB) AS image_data)),
	('Nursing', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\Nursing.jpeg', SINGLE_BLOB) AS image_data)),
	('pharma', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\pharmacy.jpg', SINGLE_BLOB) AS image_data)),
	('physical therapy', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\physical_therapy.jpg', SINGLE_BLOB) AS image_data)),
	('Veterinary_Medicine', (SELECT BulkColumn FROM OPENROWSET(BULK 'E:\collage\spring 2024\machine learning\ahlia-project\static\images\universities\Veterinary_Medicine.png', SINGLE_BLOB) AS image_data));
