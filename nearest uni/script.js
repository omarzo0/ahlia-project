...
const collegesCoordinates = {
    "International Academy - El Alamein": { latitude: 30.812425108622012, longitude: 28.929221544299974 },
    "King Salman International University": { latitude: 28.237790686879233, longitude: 33.64926962890776 },
    "Al-Jalalah University": { latitude: 29.433486474044066, longitude: 32.40276508531423 },
    "New Mansoura University": { latitude: 31.46734755656675, longitude: 31.456074360307362 },
    "Ismailia National University": { latitude: 30.585505392260647, longitude: 32.354599745662725},
    "East Portsaid National University": { latitude: 31.020730208920604, longitude: 32.62685115057633},
    "Benha  National University": { latitude: 30.245117102759714, longitude: 31.457472906929397},
    "Helwan National University": { latitude: 29.872980652067906, longitude: 31.317419452589697},
    "Beni-Suef National University": { latitude: 29.03486876722051, longitude: 31.121882120109884},
    "Minia National University": { latitude: 28.07641914254702, longitude: 30.83577692087913},
    "Assiut National University( ANU )": { latitude: 27.27449804017888, longitude: 31.275639691133634},
    "Sohag University National": { latitude: 26.45244464143984, longitude: 31.66147480166755}
};
...
function findNearestCollege() {
    ...
    for (const college in collegesCoordinates) {
        ...
        const distance = calculateDistance(userLocation.latitude, userLocation.longitude, collegeLocation.latitude, collegeLocation.longitude);
